...
namespace SadJamEditor.Components
{
    ...
    public class Convertor_FloatToQuaternion : StructConvertor<StructComponent<Single>>
    {
        public override void ConvertMeAs(GameObject target, Type targetType, StructComponent<Single> input, object before, Action<object> done, params object[] customData)
        {
