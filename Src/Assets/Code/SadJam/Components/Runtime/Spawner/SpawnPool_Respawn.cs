...
{
    [ClassTypeAddress("Executor/Spawner/Respawn")]
    public class SpawnPool_Respawn : DynamicExecutor
    {
        ...
        protected override void DynamicExecutor_OnExecute()
        {
            ...
            SpawnPool.Destroy(gameObject, (bool destroyedFromThis) =>
            {
                if (!destroyedFromThis || this == null || gameObject == null) return;
