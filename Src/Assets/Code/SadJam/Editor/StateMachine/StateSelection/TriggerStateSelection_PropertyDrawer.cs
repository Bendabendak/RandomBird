...
{
    [CustomPropertyDrawer(typeof(Selection_TriggerState))]
    public class TriggerStateSelection_PropertyDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            EditorGUI.BeginProperty(position, label, property);

            SerializedProperty globalStateChangerProp = property.FindPropertyRelative(nameof(Selection_TriggerState.GlobalStateHolder));
            SerializedProperty stateProp = property.FindPropertyRelative(nameof(Selection_TriggerState.Trigger));
            SerializedProperty isLocalProp = property.FindPropertyRelative(nameof(Selection_TriggerState.Local));
