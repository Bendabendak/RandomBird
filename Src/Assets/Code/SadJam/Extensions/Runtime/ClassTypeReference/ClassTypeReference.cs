...
namespace TypeReferences
{
	...
	public sealed class ClassTypeReference : ISerializationCallbackReceiver {
		...
		public static IEnumerable<Type> GetFilteredTypes(ClassTypeConstraintAttribute filter)
		{
			...
			{
				foreach (Type t in FilterTypes(assembly, filter, excludedTypes))
				{
					yield return t;
				}
			}
		...
		private static IEnumerable<Type> FilterTypes(Assembly assembly, ClassTypeConstraintAttribute filter, ICollection<Type> excludedTypes)
		{
